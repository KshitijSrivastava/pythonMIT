...
def is_word_guessed(secret_word, letters_guessed):
    ...
    #dict_secret_word=dict(list_secret_word)
    counts=dict()
    for word in list_secret_word:    
        counts[word] = counts.get(word,0) + 1 
        
    for element in list_secret_word:
...
def get_guessed_word(secret_word, letters_guessed):
    ...
    for element in list_secret_word:
        if element in letters_guessed:
            guessed_word_list.append(element)
        else:
...
def get_available_letters(letters_guessed):
    ...
    avail_alphabet=''.join(alphabet_list)
    return avail_alphabet
    ...
    while chances>0:
        ...
        if guess_word in wordinlist:
            ...
            if is_word_guessed(word, letters_guessed):
                ...
                print('Your total score in this game is ', len(letters_guessed)*chances)
        else:
            print('The letter is not in my word:',get_guessed_word(word, letters_guessed) )
            chances=chances-1
            
        if chances==0:
            print('You have lost. The correct word is ', word)
